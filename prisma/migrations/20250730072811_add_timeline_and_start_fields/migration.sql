...
ALTER TABLE `bookmarks` ADD COLUMN `collection_id` INTEGER NULL,
    ADD COLUMN `timeline` INTEGER NULL DEFAULT 0;
...
-- AlterTable
ALTER TABLE `rooms` ADD COLUMN `startTime` INTEGER NOT NULL DEFAULT 0,
    ADD COLUMN `startType` ENUM('BOOKMARK', 'BEGINNING') NOT NULL DEFAULT 'BEGINNING',
    MODIFY `video_id` VARCHAR(20) NULL;
